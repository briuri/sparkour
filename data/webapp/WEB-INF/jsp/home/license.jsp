...
<p>Sparkour is Copyright &copy; 2016 - 2020 by Brian Uri!.
...
<p>Sparkour makes use of many third-party libraries, whose licenses are linked here:</p>

<div class="license">
	<ul>
		<li>Core Libraries<ul>
			<li><a href="https://spark.apache.org/">Apache Spark 2.4.5</a>
				(<a href="http://www.apache.org/licenses/LICENSE-2.0">Apache License 2.0</a>):
				Core data processing engine (unmodified).</li>
		</ul></li>

		<li>Website Server-side Libraries<ul>
			<li><a href="http://tomcat.apache.org/">Apache Tomcat 10.1.17</a>
				(<a href="http://www.apache.org/licenses/LICENSE-2.0">Apache License 2.0</a>):
			...
			<li><a href="https://github.com/jakartaee/tags">JSTL 3.0.1</a>
				(<a href="https://github.com/jakartaee/tags/blob/master/LICENSE.md">Eclipse Public License 2.0</a>):
			...
			<li><a href="http://www.slf4j.org/">SLF4J 1.7.28</a>
				...
				Logging (unmodified).</li>
			<li><a href="http://projects.spring.io/spring-framework/">Spring Framework 6.1.2</a>
				(<a href="http://www.apache.org/licenses/LICENSE-2.0">Apache License 2.0</a>):
